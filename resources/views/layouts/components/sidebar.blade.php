<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <div class="collapse {{ Request::segment(2) == 'brands' ? 'show' : '' }}" id="collapseBrands" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
            ...
            <div class="collapse {{ Request::segment(2) == 'categories' ? 'show' : '' }}" id="collapseCategories" aria-labelledby="headingOne"
