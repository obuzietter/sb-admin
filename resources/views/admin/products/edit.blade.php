    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="is_enabled" name="is_enabled"
                                    value="1" {{ $product->is_enabled ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" class="form-control" id="minimum_order_quantity"
                                    name="minimum_order_quantity" value="{{ $product->minimum_order_quantity }}"
                                    min="0">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="special_price"
                                    name="special_price" value="{{ $product->special_price }}" min="0">
                            </div>
                            <!-- Wholesale Price -->
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="whole_sale_price"
                                    name="whole_sale_price" value="{{ $product->whole_sale_price }}" min="0">
                            </div>
                        </div>
                        <div class="row">
                            <!-- Sale Price -->
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="sale_price"
                                    name="sale_price" value="{{ $product->sale_price }}" min="0">
                            </div>
                            <!-- Sale Criteria -->
                            <div class="col-md-3 mb-3">
                                <label for="sale_criteria" class="form-label">Sale Criteria</label>
                                <select class="form-select" id="sale_criteria" name="sale_criteria">
                                    <option value="NONE" {{ $product->sale_criteria == 'NONE' ? 'selected' : '' }}>None
                                    </option>
                                    <option value="DATE" {{ $product->sale_criteria == 'DATE' ? 'selected' : '' }}>Date
                                    </option>
                                    <option value="QUANTITY"
                                        {{ $product->sale_criteria == 'QUANTITY' ? 'selected' : '' }}>
                                        Quantity</option>
                                </select>
                            </div>
                            <!-- Sale Start Date -->
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="tax_id" name="tax_id">
                                    ...
                                    @foreach ($taxes as $tax)
                                        <option value="{{ $tax->id }}"
                                            {{ $product->tax_id == $tax->id ? 'selected' : '' }}>{{ $tax->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="row justify-content-end">
                <button type="submit" class="btn btn-primary col-3"><i class="fa-solid fa-right-to-bracket"></i> Save
                    Changes</button>
            </div>
        </form>
    </div>
